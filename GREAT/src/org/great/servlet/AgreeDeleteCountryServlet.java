...
/**
 * Servlet implementation class DeleteUntreatedInfoServlet
 */
@WebServlet("/AgreeDeleteCountryServlet")
public class AgreeDeleteCountryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AgreeDeleteCountryServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TreatedInfo treatedInfo = new TreatedInfo(id,type,content,applicant,application_date,checker,check_date,"同意");
		...
		if(result1) {
			...
			result2 = countryServiceImpl.deleteCountry(en_name);
			//删除未处理信息
