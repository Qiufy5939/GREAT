...
/**
 * Servlet implementation class AgreeLockUserServlet
 */
@WebServlet("/AgreeLockUserServlet")
public class AgreeLockUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AgreeLockUserServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//锁住
				...
				if (ad_name!=null) {
					...
					TreatedInfo treatedInfo = new TreatedInfo(id,type,content,applicant,application_date,checker,check_date,"永久封号");
					...
					if(result1) {
						...
						result2 = user_informationServiceImpl.deleteUser_information(user);
						
						
						//删除未处理信息
						result3 = untreatedInfoServiceImpl.deleteUntreatedInfo(id);
					}
